package com.example.rakeshtest.ui
...
import com.example.rakeshtest.ui.presentation.addNoteScreen.AddNoteScreen
import com.example.rakeshtest.ui.presentation.homeScreen.HomeScreen
import com.example.rakeshtest.ui.presentation.updateNoteScreen.UpdateNoteScreen
        ...
        composable(route = JournalAppScreens.Home.name) {
            HomeScreen(
                ...
                navigateToAboutScreen = {
                   // navController.navigate(JournalAppScreens.About.name)
                }
            )
        }
